...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "2026-04-25",
    highlights: [
      { type: "changed", text: "Publish workflow — release job runs on Node 24 so npm 11.5+ satisfies OIDC provenance requirements for npm publish (#48)" },
...
/** Shipped semver releases only (excludes `Unreleased`). */
export const CHANGELOG_RELEASE_COUNT = CHANGELOG.filter(
